...
public class CustomColorPickerComposite extends AbstractColorsComposite {
  ...
  private void createContent(Composite parent) {
    ...
    buttonLabel.setText("Select Color");//ModelMessages.SelectColorButton
  ...
  private void previewComposite(Composite parent) {
    ...
    previewTextBackgroundBlack.setText("EXAMPLE");
    ...
    previewTextBackgroundWhite.setText("EXAMPLE");
  }
